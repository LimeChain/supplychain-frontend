...
const envVariables = [
    ...
    'HEDERA_INTERGRATION_NODE_CREDIT_PRODUCT_SUFFIX',
    'TARGET_INSTANCE_01_URL',
    'TARGET_INSTANCE_02_URL',
];
...
const Config = {
    ...
    Server: {
        ...
        HEDERA_INTERGRATION_NODE_CREDIT_PRODUCT_SUFFIX: process.env.HEDERA_INTERGRATION_NODE_CREDIT_PRODUCT_SUFFIX,
        TARGET_INSTANCE_01_URL: process.env.TARGET_INSTANCE_01_URL,
        TARGET_INSTANCE_02_URL: process.env.TARGET_INSTANCE_02_URL,
    },
    Path: {
